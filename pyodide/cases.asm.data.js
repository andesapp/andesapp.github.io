...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'cases.asm.data';
    var REMOTE_PACKAGE_BASE = 'cases.asm.data';
...
Module['FS_createPath']('/', 'cases', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_cases.asm.data');

    };
    Module['addRunDependency']('datafile_cases.asm.data');
